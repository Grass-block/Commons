...
public class NBTTagCompound extends NBTBase {
    ...
    public void readTagContents(final DataInput dataInput) throws IOException {
        this.tagMap.clear();
        NBTBase namedTag;
        while ((namedTag = NBT.read0(dataInput)).getType() != 0) {
	...
	public void setIntArray(String string, int[] intArr2) {
		this.tagMap.put(string, new NBTTagIntArray(intArr2).setKey(string));
	}
	...
	public int[] getIntArray(String string) {
        ...
        return ((NBTTagIntArray)this.tagMap.get(string)).intArray;
	}
